...
public class TFGController {
    ...
    public String lista(Model model, Principal principal) {
        ...
        if (principal == null || principal.getName().equals(""))
            ...
            lista = Arrays.asList(restTemplate.getForEntity(TFGMANAGER_STRING + "profesor/" + principal.getName(),TFG[].class).getBody());
    ...
    @PostMapping("/upload")
    public String uploadFile(@RequestParam("file") MultipartFile file, @RequestParam("email") String email, Principal principal) {
